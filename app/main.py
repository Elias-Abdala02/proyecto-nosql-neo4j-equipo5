...
NEO4J_URI = os.getenv("NEO4J_URI", "neo4j+s://257b501e.databases.neo4j.io")
NEO4J_USER = os.getenv("NEO4J_USER", "neo4j")
NEO4J_PASSWORD = os.getenv("NEO4J_PASSWORD", "6euITjyHAIxRU3dtVQHZ5Y9kjKEUNfOMzLUsH3s9IGU")
...
def seed_database():
    try:
        ...
        # Importar nodos desde GitHub raw
